...
namespace CurrencyExchangerConsole.Classes
{
    public class AddRatePurchaseSale
    {
        ...
        {
            string connectionString = "Data Source=.\\SQLEXPRESS;Database=CurrencyExchanger_db;Trusted_Connection=True;";
            string addRateQuery = "INSERT INTO Rate_Purchase_Sale VALUES(@OperatorId, @DigitalCurrencyCode, @Rate_Purchase, @Rate_Sale, @Coefficient, @DateOfIssue, @DateOfTheStartAction);";
            ...
            try
            {
                ...
                {
                    ParameterName = "@Rate_Purchase",
                    Value = RatePurchase
                };
                SqlParameter rateSale = new SqlParameter
                {
                    ParameterName = "@Rate_Sale",
                    Value = RateSale
                };
