...
namespace CurrencyExchangerConsole.Classes
{
    public class Coefficients
    {
        ...
        public void AddCoefficientPurchaseSale(string Coefficient, string AlphabeticCurrencyCode, string OperationType)
        {
        ...
        public void AddCoefficientConversion(string Coefficient, string AlphabeticCurrencyCode, string SecondAlphabeticCurrencyCode, string OperationType)
        {
